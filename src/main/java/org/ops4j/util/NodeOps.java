...
{
  public static List<NodeOp<?>> create(String args)
  {
  ...
  public static List<NodeOp<?>> create(List<String> args)
  {
  ...
  public static List<NodeOp<?>> create(String args[])
  {
    Map<String, NodeOp<?>> opMap = Ops4J.locator().getNodeOps();
